...
- Always make sure the program will compile without errors or warnings.  Fix and errors or warnings.
- Always make sure the unit tests compile without errors or wanrings and the tests run without failures.   Fix any errors or warnings or test failures.
