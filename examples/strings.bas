...
1230 NEXT I
1240 PRINT
1250 PRINT "=== SINGLE QUOTES IN STRINGS ==="
1260 PRINT "IT'S A TEST"
1270 PRINT "DON'T STOP BELIEVIN'"
1280 Q$ = "CAN'T"
1290 PRINT "Q$ = "; Q$
1300 PRINT "LEN(Q$) ="; LEN(Q$)
1310 PRINT "MID$(Q$, 4, 1) = ["; MID$(Q$, 4, 1); "]"
1320 PRINT "INSTR(Q$, ""'"") ="; INSTR(Q$, "'")
1330 PRINT
1340 PRINT "DONE."
1350 END
