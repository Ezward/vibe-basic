...
140 REM *   DAVID MENY    *
150 REM *******************
160 REM CLS:KEY OFF:DEFINT A-Z
...
9080 FOR I=1 TO 100:NEXT I:PRINT:END
...
25570 DATA "Captains Quarters","Your Cabin","Hallway","Port Deck","Port Deck"
25580 DATA "Crews Cabin","Hallway","Mid Deck","Mid Deck","Crows Nest","Crows Nest"
25590 DATA "Mess Hall","Hallway","Starboard Deck","Starboard Deck","Galley","Hallway"
25600 DATA "Ships Library","Under Water","Top of the Bay","Bottom of the Bay"
